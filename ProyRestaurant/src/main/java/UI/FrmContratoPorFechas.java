...
public class FrmContratoPorFechas extends javax.swing.JFrame {
    ...
    /**
     * Creates new form FrmContratoPorFechas
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmContratoPorFechas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmContratoPorFechas().setVisible(true);
            }
        });
    }
