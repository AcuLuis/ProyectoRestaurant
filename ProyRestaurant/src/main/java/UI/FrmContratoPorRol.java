...
public class FrmContratoPorRol extends javax.swing.JFrame {
    ...
    /**
     * Creates new form FrmContratoPorRol
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmContratoPorRol.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmContratoPorRol().setVisible(true);
            }
        });
    }
