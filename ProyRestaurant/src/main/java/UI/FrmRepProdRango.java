 ...
 * @author Lghos
 */
public class FrmRepProdRango extends javax.swing.JFrame {

    /**
     * Creates new form FrmRepProdRango
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmRepProdRango.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmRepProdRango().setVisible(true);
            }
        });
    }
